...
AMPLITUDE       = 0.02
U_BOUNDS        = 0.05
OUTPUT_DIR      = Path("/scratch/j_mens07/data/2_funding_period/dynamic/AC/freq_manipulation/")
...
def main():
    ...
    control_sample = np.random.uniform(-U_BOUNDS,U_BOUNDS,(N_SAMPLES,6))
