...
def run_simulation(time_steps, voltages, topology_parameter, folder, stat_size, f0):
    ...
    sim_class           = nanonets.simulation(topology_parameter=topology_parameter, folder=folder,
                                              high_C_output=False, add_to_path=f"_{f0/1e6}")
...
if __name__ == '__main__':
    ...
    # freq_vals   = [0.5,1.,2.,5.,6.,8.,10.,12.,15.,18.,]
    # freq_vals   = [23.,28.,36.,44.,55.,68.,86.,105.,133.]
    freq_vals   = [0.001,0.002,0.004,0.006,0.008,0.01,0.03,0.06,0.12,0.25]
