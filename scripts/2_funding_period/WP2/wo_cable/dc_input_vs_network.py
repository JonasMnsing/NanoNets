...
if __name__ == '__main__':
    ...
    if topology_parameter["electrode_type"][-1] == 'floating':
        ...
        folder      = "/home/j/j_mens07/phd/data/2_funding_period/potential/wo_magic_cable/dc_input_vs_network/"
    else:
        # folder      = "/mnt/c/Users/jonas/Desktop/phd/data/2_funding_period/current/wo_magic_cable/dc_input_vs_network/"
        folder      = "/home/j/j_mens07/phd/data/2_funding_period/current/wo_magic_cable/dc_input_vs_network/"
