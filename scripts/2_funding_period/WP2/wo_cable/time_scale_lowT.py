...
def run_simulation(time_steps, voltages, topology_parameter, folder, stat_size):
    ...
    sim_class.run_var_voltages(voltages=voltages, time_steps=time_steps, target_electrode=target_electrode, stat_size=stat_size, save=True, T_val=1.0)
...
if __name__ == '__main__':
    ...
    folder      = "/mnt/c/Users/jonas/Desktop/phd/data/2_funding_period/potential/wo_magic_cable/time_scale/lowT/"
