...
def run_simulation(voltages, time_steps, network_topology, topology_parameter, res_info2, eq_steps, folder, stat_size, seed):
    ...
    sim_class = nanonets.simulation(network_topology=network_topology, topology_parameter=topology_parameter, res_info2=res_info2, folder=folder+"data/", seed=seed, add_to_path=f'_{R_val}')
...
if __name__ == '__main__':
    ...
    # Parameter
    folder              = "scripts/2_funding_period/WP2/step_input/1I_1O_R_alternating/"
    stat_size           = 500
    eq_steps            = 1000000
