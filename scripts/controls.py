...
if __name__ == '__main__':
    ...
    def parallel_code(thread, rows, v_rand, v_gates, i1, i2, N_voltages, N_values):
        ...
        for N in N_values:
            ...
            positions       = [[topology_parameter["Nx"]-1,topology_parameter["Ny"]-2,0],[topology_parameter["Nx"]-2,topology_parameter["Ny"]-1,0]]
            ...
            folder                      = "/mnt/c/Users/jonas/Desktop/phd/NanoNets/test_runs/"#"/scratch/tmp/j_mens07/data/controls/"
