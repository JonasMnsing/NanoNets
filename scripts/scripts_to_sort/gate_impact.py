...
if __name__ == '__main__':
    ...
    v_rand              = voltage_config.uniform_config(low=-0.05, high=0.05, N_rows=1, N_cols=(N_electrodes-1))
    v_rand              = np.repeat(v_rand, N_voltages, axis=0)
    v_gates             = np.linspace(-0.1,0.1,N_voltages)
