...
if __name__ == '__main__':
    ...
    def parallel_code(thread, rows, v_rand, v_gates, N_voltages, N_electrodes):
        ...
        for Temp in [2,4,8,16,32,64]:
            ...
            folder              = f"/home/jonas/phd/data/temperature_var_s/T={Temp}_"#f"/mnt/c/Users/jonas/Desktop/phd/data/temperature/T={Temp}_"
            ...
            nanonets.cubic_net_simulation(target_electrode, topology_parameter, voltages.values[thread_rows,:], folder,
                                save_th=10, tunnel_order=tunnel_order, T_val=Temp, sim_dic=sim_dic, np_info2=np_info2)
