...
class kmc_dn():
    ...
    def place_dopants_random(self):
        ...
        rs1 = np.random.RandomState(17)
        self.acceptors  = rs0.rand(self.N, 3)
        self.donors     = rs1.rand(self.M, 3)
    ...
    def update_static_electrodes(self, electrodes):
        self.static_electrodes = electrodes
        # self.P = self.electrodes.shape[0]
        self.initialize(dopant_placement=False, charge_placement=False)
