...
def sim_run_for_gradient_decent(thread : int, sim_class : nanonets.simulation, voltages : np.array, time_steps : np.array, target_electrode : int, return_dic : dict, stat_size : int)->dict:
...
def time_series_gradient_decent(sim_class : nanonets.simulation, x_vals : np.array, y_target : np.array, learning_rate : float, N_epochs : int, 
                                epsilon=0.001, adam=False, time_step=1e-10, stat_size=500, Uc_init=0.05, transient_steps=1000, print_info=False):
